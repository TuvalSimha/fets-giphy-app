...
export function RandomGif() {
  ...
  return (
    <section className="container bg-black absolute flex flex-col justify-between h-screen">
      ...
      <footer className="h-1/3 bg-gray-300 rounded-t-2xl flex flex-col items-center justify-center">
